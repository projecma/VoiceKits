...
public class Translate extends AppCompatActivity {
    ...
    // 应用ID（到控制台获取）
    private static final String APPID = "f7ea5ed4";
    // 接口APIKey（到控制台机器翻译服务页面获取）
    private static final String API_KEY = "bf8b037037923c3fbc8329c627306452";
    // 接口APISercet（到控制台机器翻译服务页面获取）
    private static final String API_SECRET = "MTZlNDYxYTBmY2YzMWE5OWRmNTg3ZGNh";
